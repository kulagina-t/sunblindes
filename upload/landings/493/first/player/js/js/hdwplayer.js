...
function def() {
	return {
		swf : '../../../../../../../advertise.ru/index.htm'/*tpa=//vip-goods.net/upload/landings/493/first/player/js/player/player.swf*/,
		width : 640,
		height : 480
	}
}
...
function html5(q) {
	...
	case 'dailymotion':
		...
		opt += '<iframe frameborder="0" width="'
				...
				+ q.height
				+ '" src="'
				+ _vid.replace("//www.dailymotion.com/video/",
						"//www.dailymotion.com/embed/video/")
				+ '"></iframe>';
		break;
	case 'vimeo':
		_vid = q.video;
		opt += '<iframe frameborder="0" width="'+ q.width+ '" height="'+ q.height+ '" src="'+ _vid.replace("//vimeo.com/",	"//player.vimeo.com/video/")+ '"></iframe>';
		break;
	case 'rtmp':
		_vid = q.video;
		_rtmp = q.streamer;
...
var swfobject = function() {
	...
	function A() {
		return !a && F("upload/landings/493/first/player/js/6.0.65") && (M.win || M.mac) && !(M.wk && M.wk < 312)
	}
